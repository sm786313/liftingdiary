...
**ALL code generated by Claude Code should FIRST refer to the relevant docs file(s) within the `/docs` directory before implementing any functionality.** Review the documentation to understand project-specific standards, component libraries, and coding conventions before making changes.

Current documentation files:
- `/docs/ui.md` - UI/UX Coding Standards (shadcn/ui components, date formatting with date-fns, styling standards)
